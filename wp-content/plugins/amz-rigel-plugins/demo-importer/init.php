...
define( 'AMZ_IMPORTER_DIR' , plugin_dir_path( __FILE__ ) );
define( 'AMZ_IMPORTER_URI' , plugins_url( '', __FILE__ ) );
...
$options        = array(
    ...
    'rigel-beautyspot' => array(
        'title'         => __('Rigel Beautyspot', 'amz-importer'),
        'preview_url'   => 'http://pixel8es.com/wpthemes/rigel/rigel-beautyspot/?pri_color=933d4a',
        ),
    'rigel-pets' => array(
        'title'         => __('Rigel Pets', 'amz-importer'),
        'preview_url'   => 'http://pixel8es.com/wpthemes/rigel/rigel-pets/?pri_color=ffde17',
        ),
    'rigel-business-solutions' => array(
        'title'         => __('Rigel Business Solutions', 'amz-importer'),
        'preview_url'   => 'http://pixel8es.com/wpthemes/rigel/rigel-business-solutions/?pri_color=0668e3',
        ),
    'rigel-restaurant' => array(
        'title'         => __('Rigel Restaurant', 'amz-importer'),
        'preview_url'   => 'http://pixel8es.com/wpthemes/rigel/rigel-restaurant/?pri_color=f2ce08',
        ),
    'rigel-business-5' => array(
        'title'         => __('Rigel Business 5', 'amz-importer'),
        'preview_url'   => 'http://pixel8es.com/wpthemes/rigel/rigel-business-5/?pri_color=13c7d6',
        ),
    'rigel-agency' => array(
