    ...
    class gallery_blocks {
        ...
        public function get_image_by_id( $width, $height, $image_id, $only_src = true, $placeholder = false ) {
            ...
            if( ! empty( $image_thumb_url ) ) {
                ...
                $placeholder = rigel_get_option_value( 'placeholder', '' );
                ...
                if( $terms ){
                    $output .= '<div class="sorter '. esc_attr( $filter_style ) .'">';
                        ...
                        $output .= '<ul id="filters" class="option-set '. esc_attr( $filter_style ) .' clearfix" >
                            <li><a href="#" class="selected" data-filter="*">'. esc_html__( 'All', 'amz-rigel-plugins' ) .'</a></li>';
                        ...
                        if( get_next_posts_link() || get_previous_posts_link() ) {
                            $output .= '<nav class="wp-prev-next ">
                                ...
                                if( get_next_posts_link() ) {
                                    $output .= '<li class="prev-link">'.get_next_posts_link( __( '&laquo; Older Entries', 'amz-rigel-plugins' )).'</li>';
                                }
                                if( get_previous_posts_link() ) {
                                    $output .= '<li class="next-link">'.get_previous_posts_link( __( 'Newer Entries &raquo;', 'amz-rigel-plugins' )).'</li>';
                                }
                                $output .= '</ul>
                            </nav>';
                        }
        ...
        public function get_column_class( $block = 'gallery_block1', $post_count ) {
            ...
            switch ( $block ) {
                ...
                case 'gallery_block1':
                    if( 1 == $post_count || 8 == $post_count  ) {
                        $class = 'col-md-6 height-600';
                    }
                    else {
                        $class = 'col-md-3 height-300';
                    }
                break;
                ...
                case 'gallery_block2':
                    if( 3 == $post_count || 4 == $post_count ) {
                        $class = 'col-md-6 height-350';
                    }
                    elseif( 6 == $post_count ) {
                        $class = 'col-md-3 height-700';
                    }
                    else {
                        $class = 'col-md-3 height-350';
                    }
                break;
                ...
                case 'gallery_block5':
                    if( 1 == $post_count || 4 == $post_count ) {
                        $class = 'col-md-6 height-300';
                    }
                    elseif( 2 == $post_count || 3 == $post_count ) {
                        $class = 'col-md-3 height-600';
                    }
                    else {
                        $class = 'col-md-3 height-300';
                    }
                ...
                // Portfolio Block 10
                case 'gallery_block10':
                    if( 3 == $post_count || 4 == $post_count || 5 == $post_count || 6 == $post_count ) {
                        $class = 'col-md-6 height-500';
                    }
                    else {
                        $class = 'col-md-3 height-400';
                    }
                break;
                ...
                case 'gallery_block12':
                    if( 4 == $post_count ) {
                        $class = 'col-md-12 height-500';
                    }
                    elseif( 2 == $post_count || 5 == $post_count ) {
                        $class = 'col-md-6 height-800';
                    }
                    else {
                        $class = 'col-md-6 height-400';
                    }
                break;
