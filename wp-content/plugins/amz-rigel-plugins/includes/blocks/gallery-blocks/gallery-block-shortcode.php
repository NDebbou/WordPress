<?php
    ...
    function rigel_gallery_blocks( $atts, $content = null, $code ){
        extract( shortcode_atts( array(
            'margin'        => '', // margin-no, margin-yes
            'image_id'      => ''
        ), $atts ) );
    ...
    add_shortcode( 'gallery_block1', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block2', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block3', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block4', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block5', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block6', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block7', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block8', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block9', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block10', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block11', 'rigel_gallery_blocks' );
    add_shortcode( 'gallery_block12', 'rigel_gallery_blocks' );