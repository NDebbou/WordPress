<?php
    ...
    function rigel_portfolio_blocks( $atts, $content = null, $code ){
        ...
        if ( have_posts() ) : 
            ...
            $output = '<div class="loadmore-wrap no-portfolio-carousel '. esc_attr( $code ) .'">';
                ...
                $output .= '<div class="wpb_row vc_row-fluid portfolio-block-container '. esc_attr( $margin ) .'">';
                    ...
                    $output .= '<div class="load-container portfolio-contents">';
                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            $output .= '<div class="load-element element '. esc_attr( $class ) .' '. esc_attr( $cat ) .' pix-portfolio-item">';

                                $output .= '<div class="portfolio-container" onclick="">';
    ...
    add_shortcode( 'portfolio_block1', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block2', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block3', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block4', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block5', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block6', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block7', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block8', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block9', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block10', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block11', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block12', 'rigel_portfolio_blocks' );
    add_shortcode( 'portfolio_block13', 'rigel_portfolio_blocks' );