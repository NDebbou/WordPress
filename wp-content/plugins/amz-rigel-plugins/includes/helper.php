...
function rigel_submit_form(){
	...
	$contact_success = __( '<strong>Email Successfully Sent!</strong><br>Thanks for contacting Us. Your email was successfully sent and we will be in touch with you soon.', 'amz-rigel-plugins' );

	$contact_error = esc_html__( 'Please check if you have filled all the fields with valid information and try again. Thank you.', 'amz-rigel-plugins' );
