<?php
	...
	$portfolio_metabox = array(
		...
		'fields'     => array(
			...
			array(
				'id'          => $amz_prefix . 'portfolio_video_style',
				'title'       => esc_html__( 'Portfolio Video Style', 'amz-rigel-plugins' ),
				'description' => esc_html__( 'Choose the single portfolio video option', 'amz-rigel-plugins' ),
				'std'         => 'normal',
				'options'     => array(
			...
			array(
				...
				'title' => esc_html__( 'Portfolio Video Iframe', 'amz-rigel-plugins' ),
				'description' => esc_html__( 'Enter the video iframe', 'amz-rigel-plugins' ),
				//'desc_tip' => 'Description tip',
