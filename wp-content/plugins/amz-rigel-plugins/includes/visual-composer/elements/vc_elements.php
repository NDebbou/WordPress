...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"admin_label" => true,
			"value" => array(
				esc_html__('Portfolio Posts', 'amz-rigel-plugins') => "posts", 
				esc_html__('portfolio Id', 'amz-rigel-plugins') => "id", 
				esc_html__('portfolio Category', 'amz-rigel-plugins') => "category"
			),
			"description" => ''
		),
		...
		array(
			"type" => "textfield",
			"heading" => esc_html__("portfolio Category", 'amz-rigel-plugins'),
			"param_name" => "portfolio_category",
			"value" => "",
			"dependency" => Array('element' => "insert_type", 'value' => 'category'),
			"description" => esc_html__("Enter the portfolio slugs seperated by commas (,). Example: brand,design", 'amz-rigel-plugins')
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
    		"type" => "colorpicker",
    		"class" => "",
    		"heading" => esc_html__( "Number color", 'amz-rigel-plugins' ),
    		"param_name" => "custom_number_color",
    		"value" => '', 
    		"description" => esc_html__( "Choose number color", 'amz-rigel-plugins' )
    	),

        array(
    		"type" => "colorpicker",
    		"class" => "",
    		"heading" => esc_html__( "Title color", 'amz-rigel-plugins' ),
    		"param_name" => "custom_title_color",
    		"value" => '', 
    		"description" => esc_html__( "Choose title color", 'amz-rigel-plugins' )
    	),
    	...
    	array(
    		...
    		"value" => '', 
    		"description" => esc_html__( "Choose icon color", 'amz-rigel-plugins' )
    	),
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
        	"type" => "colorpicker",
        	"heading" => esc_html__( "Title Text Color", 'amz-rigel-plugins' ),
        	"param_name" => "title_color",
        	"value" => '', 
        	"description" => esc_html__( "Choose title color", 'amz-rigel-plugins' )
        	),
        ...
        array(
        	"type" => "colorpicker",
        	"heading" => esc_html__( "Title Background Color", 'amz-rigel-plugins' ),
        ...
        array(
        	"type" => "colorpicker",
        	"heading" => esc_html__( "Content Color", 'amz-rigel-plugins' ),
        	"param_name" => "content_color",
        	"value" => '', 
        	"description" => esc_html__( "Choose Icon Box Content color", 'amz-rigel-plugins' )
        	),
...
vc_map( array(
	...
	"params" => array(
    	...
    	array(
    		"type" => "colorpicker",
    		"class" => "",
    		"heading" => esc_html__( "Sub Title color", 'amz-rigel-plugins' ),
    		"param_name" => "custom_sub_title_color",
    		"value" => '', 
    		"description" => esc_html__( "Choose sub title color", 'amz-rigel-plugins' )
    	),
    	...
    	array(
    		...
    		"class" => "",
    		"heading" => esc_html__( "Line color", 'amz-rigel-plugins' ),
    		"param_name" => "custom_line_color",
    		"value" => '', 
    		"description" => esc_html__( "Choose line color", 'amz-rigel-plugins' )
    	),
