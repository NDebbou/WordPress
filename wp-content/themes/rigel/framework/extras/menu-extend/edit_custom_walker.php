				...
				<div class="menu-item-handle">
					...
					<span class="item-controls">
						...
						<span class="item-order hide-if-js">
							...
							?>" class="item-move-up" aria-label="<?php esc_attr_e( 'Move up', 'rigel' ) ?>">&#8593;</a>
							|
							<a href="<?php
								echo wp_nonce_url(
									add_query_arg(
							...
							?>" class="item-move-down" aria-label="<?php esc_attr_e( 'Move down', 'rigel' ) ?>">&#8595;</a>
						</span>
						<a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" href="<?php
							echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
						?>" aria-label="<?php esc_attr_e( 'Edit menu item', 'rigel' ); ?>"><?php esc_html_e( 'Edit', 'rigel' ); ?></a>
					</span>
				</div>
			</div>
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
				...
				<p class="field-link-target description">
					<label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
						...
						<?php esc_html_e( 'Open link in a new tab', 'rigel' ); ?>
					</label>
				</p>
	            ...
	            <?php //Mega Menu Columns ?>
		            <div class="pix-field-custom-megamenucol description description-wide">
						...
						<div class="switch-toggle switch-5 switch-candy" onclick="">
							...
							<label for="edit-menu-item-megamenucol2-<?php echo esc_attr( $item_id ); ?>" onclick=""><?php esc_html_e('2','rigel' ); ?></label>
							...
							<label for="edit-menu-item-megamenucol3-<?php echo esc_attr( $item_id ); ?>" onclick=""><?php esc_html_e('3','rigel' ); ?></label>
							...
							<label for="edit-menu-item-megamenucol4-<?php echo esc_attr( $item_id ); ?>" onclick=""><?php esc_html_e('4','rigel' ); ?></label>
							...
							<label for="edit-menu-item-megamenucol5-<?php echo esc_attr( $item_id ); ?>" onclick=""><?php esc_html_e('5','rigel' ); ?></label>
							...
							<label for="edit-menu-item-megamenucol6-<?php echo esc_attr( $item_id ); ?>" onclick=""><?php esc_html_e('6','rigel' ); ?></label>
							<a></a>
						</div>
	            ...
	            <div class="pix-field-custom-megamenubgimg description description-wide">
	                ...
	                <div class="pix-pull-left pix_image_select pix-container">
	                	...
	                	<a href="#" class="select-files" data-title="Insert Images"  data-file-type="image" data-multi-select="false" data-insert="true"><?php esc_html_e('Insert Images', 'rigel' ); ?></a>
	                </div>	                
	            ...
	            <p class="pix-field-custom-newtag description description-wide">
	                <label for="edit-menu-item-newtag-<?php echo esc_attr( $item_id ); ?>">
	                    <?php esc_html_e( 'New Tag', 'rigel' ); ?><br />
						<span class="switch-light switch-candy" onclick="">
				...
				<p class="field-imageurl description description-wide">
					<label for="edit-menu-item-imageurl-<?php echo esc_attr( $item_id ); ?>">
						<?php esc_html_e( 'Image URL', 'rigel' ); ?><br />
						...
						<span class="imageurl"><?php esc_html_e('The imageurl will be displayed in the menu if the current theme supports it.', 'rigel' ); ?></span>
					</label>
				</p> */ ?>
	            ...
	            <p class="pix-field-custom-megamenuchildtitle description description-wide">
	                <label for="edit-menu-item-megamenuchildtitle-<?php echo esc_attr( $item_id ); ?>">
	                    <?php esc_html_e( 'Display as Title', 'rigel' ); ?><br />
						<span class="switch-light switch-candy" onclick="">
				...
				<fieldset class="field-move hide-if-no-js description description-wide">
                    <span class="field-move-visual-label" aria-hidden="true"><?php esc_html_e( 'Move', 'rigel' ); ?></span>
                    <button type="button" class="button-link menus-move menus-move-up" data-dir="up"><?php esc_html_e( 'Up one', 'rigel' ); ?></button>
                    <button type="button" class="button-link menus-move menus-move-down" data-dir="down"><?php esc_html_e( 'Down one', 'rigel' ); ?></button>
                    <button type="button" class="button-link menus-move menus-move-left" data-dir="left"></button>
                    <button type="button" class="button-link menus-move menus-move-right" data-dir="right"></button>
                    <button type="button" class="button-link menus-move menus-move-top" data-dir="top"><?php esc_html_e( 'To the top', 'rigel' ); ?></button>
                </fieldset>

				<div class="menu-item-actions description-wide submitbox">
					<?php if ( 'custom' != $item->type && $original_title !== false ) : ?>
						<p class="link-to-original">
							<?php printf( __('Original: %s', 'rigel' ), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
					<?php endif; ?>
					...
					); ?>"><?php esc_html_e( 'Remove', 'rigel' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr( $item_id ); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
						?>#menu-item-settings-<?php echo esc_attr( $item_id ); ?>"><?php esc_html_e('Cancel', 'rigel'); ?></a>
				</div>
