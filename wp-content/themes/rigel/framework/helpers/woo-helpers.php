            ...
            ?>      
                    ...
                    <div class="cart-trigger">
                        <div class="pix-cart-contents-con">                 
                            <a class="pix-cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php _e('View your shopping cart', 'rigel' ); ?>"><span class="pixicon-cart pix-cart-icon"></span><span class="pix-item-icon"><?php echo esc_html( WC()->cart->cart_contents_count ); ?></span></a>
                        </div>
    ...
    if( !function_exists( 'rigel_woocommerce_header_add_to_cart_fragment' ) ) { 
        function rigel_woocommerce_header_add_to_cart_fragment( $fragments ) {
            ...
            echo '<div class="pix-cart-contents-con">';             
                echo '<a class="pix-cart-contents" href="'. esc_url( wc_get_cart_url() ) .'" title="'. esc_html__('View your shopping cart', 'rigel' ) .'"><span class="pixicon-cart pix-cart-icon"></span><span class="pix-item-icon">'. esc_html( WC()->cart->cart_contents_count ) .'</span></a>';
            echo '</div>';
