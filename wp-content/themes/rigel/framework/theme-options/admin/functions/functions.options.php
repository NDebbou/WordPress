...
if (!function_exists('of_options'))
{
	...
	function of_options()
	{
		...
		$pagination = array( "loadmore" => "Load More Button", "autoload" => "Autoload", "number" => "Number", "text" => "Text" );
...
$of_options[] = array( 	"name" 		=> esc_html__("Container Background Color", 'rigel' ),
						"desc" 		=> esc_html__("This is the container background color.(its applied for most of the items in the theme such as button, link etc..", 'rigel' ),
