...
function rigel_scripts_and_styles() {
	...
	wp_enqueue_style( 'rigel-icon-fonts', get_template_directory_uri() . '/_css/pix-icons.css', array(), '1.6', 'all' );
	wp_enqueue_style( 'animate', get_template_directory_uri() . '/_css/animate.min.css', array(), '1.6', 'all' );
	wp_enqueue_style( 'rigel-plugin-stylesheet', get_template_directory_uri() . '/_css/plugins.css', array(), '1.6', 'all' );
	wp_enqueue_style( 'rigel-stylesheet', get_template_directory_uri() . '/_css/main.css', array(), '1.6', 'all' );
	wp_enqueue_style( 'rigel-responsive', get_template_directory_uri() . '/_css/responsive.css', array(), '1.6', 'all' );

	if ( class_exists( 'Woocommerce' ) ) {
		wp_enqueue_style( 'rigel-woo-stylesheet', get_template_directory_uri() . '/_css/woo.css', array('rigel-plugin-stylesheet'), '1.6', 'all' );
	}

	$to_last_saved_time = get_theme_mod( 'to_last_saved_time', '1.6' );
	if( is_multisite() ) {
	...
	wp_enqueue_script( 'rigel-plugins-js', get_template_directory_uri() . '/_js/plugins.js', array( 'jquery' ), '1.6', true );

	wp_enqueue_script( 'rigel-scripts-js', get_template_directory_uri() . '/_js/scripts.js', array( 'jquery', 'waypoints', 'rigel-plugins-js' ), '1.6', true );
