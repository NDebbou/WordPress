...
<body <?php body_class(); ?>>
	...
	<div class="mobile-menu-nav <?php echo esc_attr( $rigel_mobile_menu_dropdown ); ?>"><div class="mobile-menu-inner"></div></div>
	...
	<div id="main-wrapper" class="clearfix <?php echo esc_attr( $rigel_header . $title_bar_class ); ?>" <?php echo ' style="background-color:'. ${$rigel_prefix.'_body_bgcolor'} .'"'; ?>>
		...
		if ( ! is_front_page() ) :
			if ( ${$rigel_prefix.'_title_bar'}  == 'show' ) {
				...
				if ( is_home() || is_archive() || is_search() || is_404()  || rigel_is_shop() ) {
