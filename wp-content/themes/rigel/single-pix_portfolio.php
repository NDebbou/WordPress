        ...
        <?php
            if ( have_posts() ) : while ( have_posts() ) : the_post();
                ...
                echo '<div class="portfolio-container row">';
                    ...
                    $rigel_video_style = rigel_get_meta_value( $rigel_id, '_amz_portfolio_video_style', 'normal' );
                    ...
                    echo '<div class="portfolio-image col-md-7">';
                        ...
                        if( 'gallery' == $rigel_single_portfolio_style ) {
                            ...
                            if( 'normal' == $rigel_video_style && !empty( $rigel_video ) ) {
                            ...
                            else if( 'iframe' == $rigel_video_style && !empty( $rigel_video_iframe ) ) {
                                echo '<div class="post-video-normal video">'. $rigel_video_iframe .'</div>';
                            }
